    ...
    , ui(new Ui::AddEmployeeView), C(conn)
{
    ...
    connect(ui->addEmployee, &QPushButton::clicked, this, &AddEmployeeView::addNewEmployee);
}
...
/*
 * Add new employee button click event handler
 *
 * Creates a new employee object then adds it to the database
 */

void AddEmployeeView::addNewEmployee() {
